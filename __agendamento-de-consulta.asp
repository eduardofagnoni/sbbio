...
oConexaoAdd.AbreConexao() 
    ...
    telefone        = SafeSQL(request.form("txtTelefone"))
    mensagem        = SafeSQL(request.form("txtMsg"))
	data			= Date()
	...
	oConexaoAdd.AddItem("INSERT INTO "&oConexaoAdd.prefixoTabela&"agende_terapia (nome, email, telefone, msg, data, dia, mes, ano) values ('"&nome&"','"&email&"','"&telefone&"','"&mensagem&"','"&data&"','"&dia&"','"&mes&"','"&ano&"')")
    ...
    'envia senha e login para o email cadastrado ********************
		...
		objCDOSYSMail.Subject = "Agendamento de consulta"
		
		'montando a mensagem'       

        mailMesg = nome&" - "&email&" - Telefone:"&telefone&"<br><br>"&mensagem
